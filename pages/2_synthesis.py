...
def get_synthesis_engine():
    """Build a synthesis engine bound to this visitor's own API key."""
    try:
        return SynthesisEngine(retriever=get_retriever(), api_key=_user_api_key)
...
def main():
    ...
    with tab1:
        ...
        topic = st.text_area(
            ...
            height=100,
            placeholder="Example: Factors explaining variation in gang violence across Latin American cities",
...
"""
    ...
    with tab2:
        ...
        **Be Specific:**
        - ✅ "Theories of criminal governance in Latin American favelas"
        - ❌ "Crime in Latin America" (too broad)

        **Frame as a Question or Theme:**
        - ✅ "What explains variation in gang violence?"
        - ✅ "The relationship between state capacity and organized crime"
        ...
        **Theoretical Reviews:**
        - "Theories of criminal governance in weak states"
        ...
        **Methodological Reviews:**
        ...
        - "Comparative case study research on organized crime"
