...
question = st.text_area(
    "Question",
    placeholder="What are the key factors that explain variation in gang violence across Latin American cities?",
    height=100,
)
...
examples = [
    ...
    "What methodologies are used to study criminal governance?",
    "Compare violence levels across different types of criminal groups",
    "What role does territorial control play in criminal governance?",
]
