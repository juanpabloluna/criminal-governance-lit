...
def get_qa_engine():
    """Build a QA engine bound to this visitor's own API key."""
    try:
        return QAEngine(retriever=get_retriever(), api_key=_user_api_key)
...
def main():
    ...
    st.markdown("Ask questions about your literature and get answers with citations from your Zotero library.")
    ...
    question = st.text_area(
        "Your Question",
        height=100,
        placeholder="Example: What factors explain variation in gang violence across Latin American cities?",
...
"""
    ...
    with st.expander("💡 Tips for Better Results"):
        ...
        **Use Academic Framing:**
        ...
        - **Collections**: Narrow to specific themed collections in your Zotero library
