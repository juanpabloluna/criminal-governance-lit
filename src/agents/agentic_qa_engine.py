...
class AgenticQAEngine:
    ...
    def _build_system_prompt(self, collections: Optional[List[str]] = None) -> str:
        ...
        prompt = """You are an expert research assistant specializing in organized crime, criminal governance, violence, and Latin American politics.

You have access to a corpus of 304 academic papers (2,512 searchable chunks) through the tools provided. Your role is to:
